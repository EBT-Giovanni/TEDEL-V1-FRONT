...
const ProformaPDFLogistica = ({data}) => {
    console.log(data)
    return (
            ...
            <Page>
                ...
                {/* CABECERA */}
                    ...
                    <View style={styles.viewInformacion}>
                        ...
                        <View style={styles.viewFechaFolio}>
                            ...
                            <View style={styles.row}>
                                <Text style={styles.containerFechaText}>{ formatFechaHoraISO8601ToCustom(data.fecha)}</Text>
                                <Text style={styles.containerFolioText}>{data.folio}</Text>
                            </View>
                        </View>
                    </View>
                ...
                {/* ==========CLIENTE=============== */}
                    ...
                    <View style={styles.viewCliente}>
                        ...
                        <View style={styles.row}><Text style={styles.nombreCliente}>{data.cliente_nombre}</Text></View>
                        <View style={styles.row}><Text style={styles.nombreCliente}>{data.cliente_nombre}</Text></View>
                        <View style={styles.row}><Text style={styles.textoCliente}>{data.cliente_nombre}</Text></View>
                        <View style={styles.row}><Text style={styles.textoCliente}>RFC: {data.cliente_rfc}</Text></View>
                        <View style={styles.row}><Text style={styles.textoCliente}>Domicilio Fiscal: {data.cliente_domfiscal}</Text></View>
                        <View style={styles.row}><Text style={styles.textoCliente}>Régimen Fiscal: {data.cliente_regimenfiscal}</Text></View>                        
                    </View>
                    {/* ================================ */}
                    ...
                    <View style={styles.viewArticulo}>
                        ...
                        <View style={styles.row}>
                            <Text style={styles.textoArticulo}> </Text>
                            <Text style={styles.textoArticulo}> </Text>
                            <Text style={styles.textoArticulo}> </Text>
                            <Text style={styles.textoArticulo}> </Text>
                            <Text style={styles.textoArticulo}> </Text>
                    ...
                    <View style={styles.viewDatosGenerales}>
                        ...
                        <View style={styles.row}>
                            <Text style={styles.textoDatosGenerales}> </Text>
                            <Text style={styles.textoDatosGenerales}> </Text>
                            <Text style={styles.textoDatosGenerales}> </Text>
                            <Text style={styles.textoDatosGenerales}> </Text>
                        </View>
                    ...
                    <View style={styles.viewMercancia}>
                        ...
                        <View style={styles.row}>
                            <Text style={styles.textoMercancia}> </Text>
                            <Text style={styles.textoMercancia}> </Text>
                            <Text style={styles.textoMercancia}> </Text>
                            <Text style={styles.textoMercancia}> </Text>
                        </View>
                    ...
                    <View style={styles.viewCaja}>
                        ...
                        <View style={styles.row}>
                            <Text style={styles.textoCaja}>{data.remolque_num}</Text>
                            <Text style={styles.textoCaja}>{data.remolque_tipo}</Text>
                            <Text style={styles.textoCaja}>{data.remolque_placa}</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.viewTractor}>
                        ...
                        <View style={styles.row}>
                            <Text style={styles.textoTractor}>{data.tractor_num_economico}</Text>
                            <Text style={styles.textoTractor}>{data.tractor_SCT}</Text>
                        </View>
                    </View>
...
export default ProformaPDFLogistica